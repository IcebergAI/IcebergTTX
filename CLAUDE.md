...
| 23 — OIDC / SSO (#25: adapter-based Authorization-Code+PKCE via Authlib, Entra + Authentik adapters, JIT provisioning, `auth_mode` local/oidc/both) | ✅ Complete |
